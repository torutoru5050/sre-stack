...
<AffiliateCTA
  ...
  description="Prometheus + Loki + Tempoをフルマネージドで。無料枠で10Kメトリクス、50GBログ付き。"
  cta="Start Free →"
  rating={4.3}
  note="Affiliate link"
/>
...
{/* TODO: Add your personal experience here — 10-15 lines about your migration / daily usage */}
...
<AffiliateCTA
  name="Grafana Cloud"
  url="https://grafana.com/cloud"
  description="Datadog比で大幅コスト削減。メトリクス重視のチームに最適なオープンソースベースの可観測性。"
  cta="See Pricing →"
  rating={4.3}
  note="Affiliate link"
/>
...
- Teams already using Prometheus + Grafana self-hosted and want to stop managing infrastructure
- Cost-conscious teams that want a credible alternative to Datadog/New Relic
...
Grafana Cloud is the best option for teams that want enterprise observability without enterprise pricing. The open-standards approach means you're never locked in, and the free tier is genuinely useful. The rough edges (Loki query speed, alerting UX) are real but improving fast.
